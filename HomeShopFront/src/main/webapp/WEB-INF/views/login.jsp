...
<div class="container"> 
    ...
    <br>
    <center>
    <h1><b>Welcome to Hom e Shop</b></h1>
        ...
        <div class="tab-pane fade" id="signup">
           ...
           <!-- Text input-->
            <div class="control-group">
              ...
              <div class="controls">
                <input id="mobile_number" class="form-control" name="mobile_number" type="number" placeholder="Enter MobileNumber" class="input-large" required="">
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input id="address" class="form-control" name="address" type="text" placeholder="Address" class="input-large" required="">
              </div>
            </div>
